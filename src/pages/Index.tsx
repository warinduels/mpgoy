...
- Universal techniques: Future faking, personalized praise, vulnerability mirroring, validation phrases`);
  ...
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-accent/20 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-secondary/30 rounded-full blur-3xl" />
      </div>
      {/* Header */}
